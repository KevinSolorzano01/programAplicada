...
my_lista.remove('Marron')    # Se elimina 'Marrón' de la lista con my_lista.remove('Marron')
print(my_lista)

my_lista.insert(8, 'Marron')
print(my_lista)

print(my_lista.pop()) #Se utiliza my_lista.pop()para eliminar el último elemento de la lista y se imprime ese elemento. Luego, se muestra la longitud de la lista.
size = len(my_lista)
print("size = ", size)
...
my_NumList.sort()               #se ordena de menor a mayor con my_NumList.sort()y se imprime
print(my_NumList)
